...
import { czcEvent, iMessageBox, MsgBox, playAD, showAwardResultPop, TimeFormat } from "../base/BaseFuncTs"
import BaseScene from "../base/baseScene/BaseScene"
import { checkAdCanReceive, loadAdConfig } from "./LobbyFunc"
...
export default class SignPop extends BaseScene {
    ...
    updateDoubleState() {
        ...
        if (!this.isSigned && DataManager.Instance.onlineParam.SignPop_normal_hide != 0) {
