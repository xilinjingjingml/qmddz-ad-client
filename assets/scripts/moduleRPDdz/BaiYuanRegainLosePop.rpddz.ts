...
export default class BaiYuanRegainLosePop extends BaseComponent {
    ...
    onOpenScene() {
        ...
        this.$("nodeFinger").active = DataManager.Instance.getOnlineParamGray("BaiYuanRegainLose_finger", true)
        this.$("btnClose").active = DataManager.Instance.getOnlineParamGray("BaiYuanRegainLose_close", true)
        DataManager.Instance.getOnlineParamGray("BaiYuanRegainLose_close_delayShow", true) && NodeExtends.delayShow(this, this.$("btnClose"))
    }
