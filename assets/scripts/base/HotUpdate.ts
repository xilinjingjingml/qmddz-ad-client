...
export default class HotUpdate extends cc.Component {
    ...
    init(path: string) {
        ...
        // console.log("jin---HotUpdate init:", this._storagePath, cc.sys.localStorage.getItem("HotUpdateSearchPaths"))
    ...
    updateCallback(event: any) {
        ...
        if (state == 1) {
            ...
            let newPath = this._assetsManager.getLocalManifest().getSearchPaths()
            Array.prototype.unshift.apply(searchPath, newPath)
            // console.log("===search = ", JSON.stringify(searchPath))
            cc.sys.localStorage.setItem('HotUpdateSearchPaths', JSON.stringify(searchPath))
