...
export default class InitBaseData {
    ...
    loadConfigs() {
        ...
        http.open(url, params, (msg) => {
            ...
            console.log("jin---0 5 7: ", DataManager.Instance.NormalBoxs, DataManager.Instance.OneYuanBoxs, DataManager.Instance.OnceBoxs,DataManager.Instance.NormalBoxs, DataManager.Instance.changeLuckyBoxs, DataManager.Instance.OnceBoxs,DataManager.Instance.OneYuanBigBoxs)
            ...
            typeof msg.onlineparam == "object" ? czcEvent("加载-2.2.1获取在线参数成功-" + DataManager.Instance.userTag) : czcEvent("加载-2.2.1获取在线参数失败-" + DataManager.Instance.userTag)
